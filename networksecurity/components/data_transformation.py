...
class DataTransformation:
    ...
    def get_data_transformation_obj(cls) -> Pipeline:
        ...
        logging.info(
            "Enter get_under_transformation_object method of the data transformation class."
        )

        try:
            knn_imputer: KNNImputer = KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            logging.info(
                f"Initialize KNN imputer with this value {DATA_TRANSFORMATION_IMPUTER_PARAMS}"
            )
    ...
    def initiateDataTransformation(self) -> DataTransformationArtifact:
        ...
        try:
            logging.info("Start Data initiation.")
